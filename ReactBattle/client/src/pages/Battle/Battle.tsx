    ...
    <div>
      ...
      <div>
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4 border-2 border-gray-500 border-dashed rounded-lg dark:border-gray-700">
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex items-center justify-center rounded bg-gray-200 h-28 dark:bg-gray-800">
                <p className="p-2 text-black dark:text-gray-500">
                  <p>{battle.desc}</p>
                </p>
              </div>
            </div>
            <div className="flex items-center justify-center h-[10%]  mb-4 rounded bg-gray-200 dark:bg-gray-800 p-3">
              <p className="text-2xl text-gray-400 dark:text-gray-500">
                {battle.imgUrl ? (
                  ...
                  <video className="w-screen h-full aspect-video" controls>
                    <source src={battle.videoUrl} type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                )}
              </p>
            </div>
            {/* this part for lead more information about project */}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center justify-center rounded bg-gray-200 h-28 dark:bg-gray-800">
                <p className="text-2xl text-black dark:text-gray-500">Github</p>
              </div>
              <div className="flex items-center justify-center rounded bg-gray-200 h-28 dark:bg-gray-800">
                <p className="text-2xl text-black dark:text-gray-500">Timer</p>
              </div>
              <div className="flex items-center justify-center rounded bg-gray-200 h-28 dark:bg-gray-800">
                <p className="text-2xl text-black dark:text-gray-500"><FcPrevious />
</p>
              </div>
              <div className="flex items-center justify-center rounded bg-gray-200 h-28 dark:bg-gray-800">
                <p className="text-2xl text-black dark:text-gray-500">
