<?php
/* Smarty version 4.3.1, created on 2023-07-20 19:21:54
  from '/var/www/html/Projects/Nehzat/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_64b98952902a21_37544734',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '26a5913504d8e219f0c600b7e5eda004ed063b00' => 
    array (
      0 => '/var/www/html/Projects/Nehzat/index.tpl',
      1 => 1689880911,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:tpls/top_logo.tpl' => 1,
    'file:tpls/footer.tpl' => 1,
  ),
),false)) {
function content_64b98952902a21_37544734 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<head>
  ...
  <link href="bootstrap-5.1.3-dist/css/bootstrap.rtl.css" rel="stylesheet">
  <!-- End of the CSS Bootstrap -->
  <!-- Link Swiper's CSS -->
  <link rel="stylesheet" href="/css/swiper-bundle.min.css">
  <!-- End of the Swiper CSS -->
  <!-- CSS Style -->
  <link rel="stylesheet" href="./css/style.css">
  <link rel="stylesheet" href="./css/media.css">
  <!-- End of the css style -->
  <!-- font awsome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
    integrity="sha512-SfTiTlX6kk+qitfevl/7LibUOeJWlt9rbyDn92a1DqWOw9vWG2MFoays0sgObmWazO5BQPiFucnnEAjpAB+/Sw=="
    crossorigin="anonymous" referrerpolicy="no-referrer" />
  <!-- End of the font awsome -->

  <title>سازمان تبلیغات اسلامی</title>
  <link rel="icon" href="/images/mini_logo.png">
</head>

<body>
  <!--====== header ======-->
  <?php $_smarty_tpl->_subTemplateRender('file:tpls/top_logo.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

  <!--End of the header-->
  <!--====== main ======-->
  <!--====== top ======-->
  <section class=" container container_custom p-0 main-body">
    <div class="wrapper_top  p-absolute"></div>
    <div class="row g-0">
      <div class="mrb_20 col-md-7 col-sm-12">
        <div class="item_one">
          <div class="swiper mySwiper  swiper-initialized swiper-horizontal swiper-backface-hidden">

            <div class="swiper-wrapper" id="swiper-wrapper-68551c128cf21510" aria-live="off">
              <div class="swiper-slide" role="group" aria-label="1 / 1">
                <div class="swiper-img">

                  <img class="swiper_slider_img" src="/images/slider.jpg" alt="">
                </div>
                <div class="swiper_slider_text" style="color: white;">
                  <p>بهار مهربانی/اداعیه رمضان به قلم سید محمد باقر علوی تهرانی «۱۲»؛</p>
                  <h2>آیا پاک دامنی و پوشش یک دستور است یا توصیه؟</h2>
                </div>
              </div>
              <div class="swiper-slide" role="group" aria-label="2 / 2">
                <div class="swiper-img">

                  <img class="swiper_slider_img" src="/images/slider2.jpg" alt="">
                </div>
                <div class="swiper_slider_text" style="color: white;">
                  <p>بهار مهربانی/اداعیه رمضان به قلم سید محمد باقر علوی تهرانی «۱۲»؛</p>
                  <h2>آیا پاک دامنی و پوشش یک دستور است یا توصیه؟</h2>
              ...
              <div class="swiper-slide" role="group" aria-label="3 / 3">
                <div class="swiper-img">
                  ...
                  <img class="swiper_slider_img" src="/images/slider3.jpg" alt="">
                </div>
                <div class="swiper_slider_text" style="color: white;">
                  <p>بهار مهربانی/اداعیه رمضان به قلم سید محمد باقر علوی تهرانی «۱۲»؛</p>
                  <h2>آیا پاک دامنی و پوشش یک دستور است یا توصیه؟</h2>
            ...
            <div class="swiper-button-next " id="btn_prev_cus" tabindex="0" aria-label="Next slide"
              aria-controls="swiper-wrapper-68551c128cf21510" aria-disabled="false">
            </div>
            <div class="swiper-button-prev " id="btn_next_cus" tabindex="0" aria-label="Previous slide"
              aria-controls="swiper-wrapper-68551c128cf21510" aria-disabled="false">
            </div>
      ...
      <div class="mrb_20 col-md-5 col-sm-12">
        <div class="item_two">
          <div class="header_nashar_first">
            <img src="/images/home/nashrekhoobiha.png" alt="">
          </div>
          <div class="header_nashar_second">
            <img src="/images/svg/l_nashr.svg" alt="">
          </div>
          <article class="nashar_content">
            <div class="nashar_content_fr">
              <div class="nashar_img">
                <img src="/images/nashar.jpg" alt="">
                <div class="control">
                  <span class="bg_gold"></span>
                  <span class="bg_radius"></span>
                  <span class="nashar_muted">خواهرنه های عاشورایی مدافعین حرم-۲</span>
                </div>
                <div class="nashar_txt">
                  <div class="nashar_titier">
                    سند صیانت از کودکان در فضای مجازی در صف تصویب
                  </div>
                </div>
                <div class="nashar_value">
                  <div class="nashare_item nashare_one">
                    <span class="nashar_number">۱۷۶۸۷</span>
                    <span class="nashar_sub">تعداد اعضا</span>
                  </div>
                  <div class="nashare_item">
                    <span class="nashar_number">۳۶۶۸۷</span>
                    <span class="nashar_sub">تعداد آثار رسیده</span>
                  </div>
                  <div class="nashare_item">
                    <span class="nashar_number">۲۵۸۴۵۶۳</span>
                    <span class="nashar_sub"> ‌ تعداد آراء</span>
                  </div>
                  <div class="clear_fix"></div>
                  <div class="nashar_login">
                    <a href="#">ورود به نشر خوبی ها</a>
                  </div>
                  <div class="clear_fix"></div>
                </div>
              </div>
            </div>
            <div class="wrapper_space_nashar"></div>
  ...
  <!--End of the top-->
  <section class="container container_custom p-0 main-body">
    <div class="p-absolute wrapper_main"></div>
    <div class="row g-0">
      <!-- right side -->
          ...
          <div class="row g-0">
            <header class="header_sec">
              <div class="section-header-general">
                ...
                <span class="section-name-header">
                  <div class="name pdl_6">
                    برگزیده ها
                  </div>
                </span>
              ...
              <div class="more_info">
                <a href="#">
                  <span class="more_info_txt">ادامه مطالب</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" viewBox="0 0 18 13">
                    <path id="Rectangle_17_copy_4" data-name="Rectangle 17 copy 4" class="cls-1"
                      d="M17.858,6.779H2.009L6.58,11.35l-0.707.707L0.095,6.279,0.8,5.572,5.58,0.794,6.287,1.5,2.008,5.78h15.85v1Z" />
                  </svg>
                </a>
              </div>
            </header>
            <div class="bargozideh_contents">
              <div class="row g-0">
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['contents']->value, 'foo');
...
?>
                  <div class="col-sm-6 col-xl-3 p-0">
                    <article class="bargozideh_content">
                      <img src="<?php echo $_smarty_tpl->tpl_vars['foo']->value['imgsrc'];?>
" alt="">
                      <div class="cnc_text">
                        <div class="htitr">
                          <a href=""> <?php echo $_smarty_tpl->tpl_vars['foo']->value['title'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                <!-- <article class="bargozideh_content">
                                      ...
                                      <div class="cnc_text">
                                        <div class="htitr">
                                          <a href="">                                                   
                                             این عادت سوخت و سازتان را کم می کند
                                          </a>
                                        </div>
                                      </div>
                                    </article> -->
                ...
                <!-- <div class="col-sm-6 col-xl-3 p-0">
                                  <article class="bargozideh_content">
                                    <img src="/images/bargozideh1.jpg" alt="">
                                    <div class="cnc_text">
                                      <div class="htitr">
                                        <a href="">
                                            نکاتی برای کاهش احتمال ابتلا به سرطان پروستات
                                        </a>
                                      </div>
                                    </div>
                                  </article>
                                ...
                                <div class="col-sm-6 col-xl-3 p-0">
                                  <article class="bargozideh_content">
                                    ...
                                    <div class="cnc_text">
                                      <div class="htitr">
                                        <a href="">
                                        اخبار منفی قتل و حوادث در جهان چطور مدیریت میشن ؟
                                        </a>
                                      </div>
                                    </div>
                                  </article>
          ...
          <div class="row g-0 ">
            <header class="header_sec ">
              <div class="section-header-general">
                <span class="bg_fr_sec"></span>
                <span class="section-name-header">
                  <div class="name pdl_6">اخبار موسسات</div>
                </span>
                <span class="bg_ls_sec"></span>
              </div>
              <div class="more_info">
            ...
            <div class="main_four">
              <div class="row g-0 ">
                <div class="col-12 col-lg-6">
                  <div class="institutes_right">
                    <div class="row ">
                      <div class="institute_m_img">
                        <img src="/images/Ins1.jpg " alt="">
                      </div>
                      <article>
                        <div class="ins_text">
                          <p class="muted"> جزییاتی از انتشار یک البوم جدید ؛</p>
                          <h6 class="Titter ins_titter">
                            حوزه هنری «باغ ارم » را منتشر کرد/به دنبال تلفیق عناصر مشترک
                          </h6>
                          <p>مرکز موسیقی حوزه هنری در تازه ترین فعالیت موسیقاتی خود آلبوم «باغ ارم » به اهنگسازی ارشاد
                            رازانی و خوانندگی مهدیا علیزاده را پیش روی مخاطبان قرار داد</p>
                        </div>
                      </article>
                    </div>
                  </div>
                ...
                <div class="col-12 col-lg-6">
                  <article class="institutes_left p-0">
                    <div class="row g-0">
                      <img src="/images/Ins2.jpg" alt="">
                      <div class="ins_text_left">
                        شناسایی ۱۱۰۴۲ بیمار جدید کرونایی/۲۱۷ نفر دیگر فوت شدند
                      </div>
                    </div>
                    <hr class="custome-line">
                    <div class="row g-0">
                      <img src="/images/Ins2.jpg" alt="">
                      <div class="ins_text_left">
                        ماجرای مین گذاری برخی مدیران برای مدیران بعدی/بازار فجر موفق است ؟
                      </div>
                    </div>
                    <hr class="custome-line">
                    <div class="row g-0">
                      <img src="/images/Ins2.jpg" alt="">
                      <div class="ins_text_left">
                        اقدام عجیب دولت برای افزایش واردات مرغ یارانه ای!
                      </div>
                    </div>
                    <hr class="custome-line">
                    <div class="row g-0">
                      <img src="/images/Ins2.jpg" alt="">
                      <div class="ins_text_left">
                        نقش نبرد «شمشیر قدس » در شکست بزرگترین نقشه ترور در تاریخ
                      </div>
                    </div>
                  </article>
                </div>
          ...
          <div class="row g-0 ">
            <header class="header_sec ">
              <div class="section-header-general">
                <span class="bg_fr_sec"></span>
                <span class="section-name-header">
                  <div class="name pdl_6">ماهنامه نهضت </div>
                </span>
                <span class="bg_ls_sec"></span>
              </div>
              <div class="more_info">
            ...
            <div class="main_five">
              <div class="row g-0 ">
                <div class="col-5 col-lg-3">
                  <div class="Nehzat_right_img">
                    <img src="/images/Nehzat.jpg " alt="">
                  </div>
                </div>
                <div class="col-7 col-lg-9">
                  <article class="Nehzat_left">
                    <article>
                      <div class="ins_text">
                        <p class="muted"> جزییاتی از انتشار یک البوم جدید ؛</p>
                        <h6 class="Titter ins_titter">
                        ...
                        <p class="d-none d-xl-block">
                          وی گفت : جریان انقلاب مسیری را خواهد رفت که این ۵ نفر با هم صحبت کنند و به سمتی
                          بروند که به پیروزی ختم شود.امروز ظرفیت خوبی برای جریان انقلاب ایجاد شده و باید ما ۵
                          نفر صحبت کنیم تا نتیجه نهایی گرفته شود. این همگرایی شدنی است و هنوز ۳ روز باقی
                          .مانده است و نتیجه خواهیم گرفت. اجازه دهید فعلا جلو برویم تا تصمیم نهایی گرفته شود
                          بنده معتقدم در جلسه ۵ نفره ابتدا تصمیم گیری انجام شود و بعد از آن اعلام کنیم.
                        </p>
                      </div>
                    </article>
        ...
        <!-- <div class="mrb_20 "> -->
        <div id="khadamat_item" class="item_six bg_khadmat ">
          <div class="row g-0 ">
            <div class="header_items khadamat_header">
              <div class="header_general">
                <div class="header_icon_khadamat"></div>
                <span class="header_name_khadamat">خدمات الکرونیک </span>
              </div>
            </div>
            <div class="e-service">
              <div class="khadamat_slider_wrapper">
                <div>
                  <div class="row">
                    <article class="col-6 col-lg-3">
                      <div class="khadamat_item">
                        <div class="khadamat_img">
                          <img src="/images/svg/khadamat/2.svg" alt="">
                        </div>
                        <div class="khadamat_text">
                          <a href="">اعزام مبلغ</a>
                        </div>
                      </div>
                    </article>
                    <article class="col-6 col-lg-3">
                      <div class="khadamat_item">
                        <div class="khadamat_img">
                          <img src="/images/svg/khadamat/1.svg" alt="">
                        </div>
                        <div class="khadamat_text">
                          <a href="">مجوز هیت</a>
                        </div>
                ...
                <div>
                  <div class="row">
                    ...
                    <div class="col-6 col-lg-3">
                      <article class="khadamat_item">
                        <div class="khadamat_img">
                          <img src="/images/svg/khadamat/3.svg" alt="">
                        </div>
                        <div class="khadamat_text">
                          <a href="">استقرار روحانی</a>
                        </div>
                      </article>
                    </div>
                    <div class="col-6 col-lg-3">
                      <article class="khadamat_item">
                        <div class="khadamat_img">
                          <img src="/images/svg/khadamat/4.svg" alt="">
                        </div>
                        <div class="khadamat_text">
                          <a href="">پرسمان</a>
                        </div>
                    ...
                    <div class="col-6 col-lg-3">
                      <article class="khadamat_item">
                        <div class="khadamat_img">
                          <img src="/images/svg/khadamat/5.svg" alt="">
                        </div>
                        <div class="khadamat_text">
                          <a href="">مدرک حفاظ</a>
                        </div>
                    ...
                    <div class="col-6 col-lg-3">
                      <article class="khadamat_item">
                        <div class="khadamat_img">
                          <img src="/images/svg/khadamat/6.svg" alt="">
                        </div>
                        <div class="khadamat_text">
                          <a href="">نظرسنجی</a>
                        </div>
              ...
              <div class="swiper-khadamat-pagination swiper-pagination"></div>
            </div>
          </div>
        </div>
        <!-- </div> -->
      ...
      <div class="col-md-5 col-sm-12">
        ...
        <div class="item_seven ">
          <div class="row g-0">
            <header class="header_sec_seven ">
              <div class="section-header-general ">
                <span class="bg_fr_sec"></span>
                <span class="section-name-header">
                  <div class="name ">آخرین اخبار</div>
                </span>
                <span class="bg_ls_sec"></span>
              </div>
            </header>
            <div class="linear_content row">
              <h3 class="Titter ">
                <a class="" href="">استقلال و پرسپولیس دهه فجر وارد بازار بورس می شوند</a>
              </h3>
            </div>
            <div class="linear_content row">
              <h3 class="Titter ">
                <a class="" href="">تلاش وزارت نیرو برای سند زدن تالاب انزلی </a>
              </h3>
            </div>
            <div class="linear_content row">
              <h3 class="Titter ">
                <a class="" href="">جریمه حرکت دنده عقب در بزرگراه و آزادراه ها</a>
              </h3>
            </div>
            <div class="linear_content row">
              <h3 class="Titter ">
                <a class="" href="">روند شکایت متقاضیان جذب هیات علمی از دانشگاهها</a>
              </h3>
            </div>
            <div class="linear_content row">
              <h3 class="Titter ">
                <a class="" href="">تشییع پیکر آیت الله نظری در سوادکوه</a>
              </h3>
            </div>
            <div class="linear_content row">
              <h3 class="Titter ">
                <a class="" href="">سامانه بارشی روز پنجشنبه وارد کشور می شود</a>
              </h3>
            </div>
          </div>
        </div>
        ...
        <div class="item_eight ">
          <div class="row g-0">
              ...
              <article class="hashtag">
                <div class="nashar_img">
                  ...
                  <div class="control">
                    <span class="bg_gold"></span>
                    <span class="bg_radius"></span>
                    <span class="hashtag_muted">خواهرنه های عاشورایی مدافعین حرم-۲</span>
                  </div>
                  <div class="nashar_txt ">
                    <div class="nashar_titier hashtag_titier">
                      نقش امام خمینی (ره) در چینش نوین منطقه غرب آسیا بر اساس معادله جدید / اولویت بخشی به فلسطین
                    </div>
                  </div>
                </div>
            </div>
            ...
            <!-- <div class="nashare_item nashare_one">
                                        ...
                                        <div class="nashare_item">
                                            <span class="nashar_number">۲۵۸۴۵۶۳</span>
                                            <span class="nashar_sub">تعداد آرا</span>
                                        </div>
                                        <div class="nashar_login">
                                            <a href="#">ورود به نشر خوبی ها</a>
                                        </div> -->
            <article class="hashtag_media">
              <div class="linear_content row"></div>
              <div class="linear_content row">
                <h3 class="Titter ">
                  <i class="fa fa-instagram"></i>
                  <a class="" href="">۱۶۱ فوتی کرونا در شبانه روز گذشته / شناسایی ۱۱۶۲۰ بیمار جدید</a>
                </h3>
              </div>
              <div class="linear_content row">
                <h3 class="Titter ">
                  <i class="fa fa-facebook-f"></i>
                  <a class="" href="">جشنواره جهانی فیلم برگزیدگانش را شناخت / دو جایزه برای «میجر»</a>
                </h3>
              </div>
              <div class="linear_content row">
                <h3 class="Titter ">
                  <i class="fa fa-twitter"></i>
                  <a class="" href="">زمان برکذاری مناظره های انتخاباتی تغییر کرد /اولین مناظره ۱۵ خرداد</a>
                </h3>
              </div>
            </article>
    ...
    padding: 5px 21px 8px 21px;
                              ...
                              <div class="linear_content row">
                                <h3 class="Titter ">
                                  <a class="" href="">وقوع زمین لرزه ۵/۱ ریشتری در ترکیه</a>
                                </h3>
                              </div>
                              <div class="linear_content row">
                                <h3 class="Titter ">
                                  <a class="" href="">کاهش فاصله گذاری های اجتماعی در ایران </a>
                                </h3>
                              </div>
                              <div class="linear_content row">
                                <h3 class="Titter ">
                                  <a class="" href="">زلزله ۴/۱ ریشتری سرگز را لرزاند</a>
                                </h3>
                              </div>
                              <div class="linear_content row">
                                <h3 class="Titter ">
                                  <a class="" href="">سخنگوی طالبان به آمریکا هشدار داد</a>
                                </h3>
                              </div>
                              <div class="linear_content row">
                                <h3 class="Titter ">
          ...
          <div class="row g-0">
            <header class="header_sec_seven ">
              <div class="section-header-general ">
                <span class="bg_fr_sec"></span>
                <span class="section-name-header">
                  <div class="name pdl_6"> سازمان در رسانه ها</div>
                </span>
                <span class="bg_ls_sec"></span>
              </div>
            </header>
  ...
  <!--End of the main-->
  <!--====== video ======-->
  <section class="container container_custom p-0 main-body video_sec">
    <div class="p-absolute wrapper_video"></div>
    <div class="row g-0">
      <header class="header_sec ">
        <div class="header_sec_video">
          <div class="header_video">
            <span class="header_video_icon"></span>
            <span class="header_video_title">
              <a href="" class="header_video_a">ویدیو</a>
            </span>
          </div>
          <div class="more_info">
            <a href="#">
              <span class="more_info_txt">ویدیو های بیشتر </span>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" viewBox="0 0 18 13">
                <path id="Rectangle_17_copy_4" data-name="Rectangle 17 copy 4" class="cls-1"
                  d="M17.858,6.779H2.009L6.58,11.35l-0.707.707L0.095,6.279,0.8,5.572,5.58,0.794,6.287,1.5,2.008,5.78h15.85v1Z" />
              </svg>
      ...
      <div class="col-12 col-lg-cus-14 order-cus-2">
        <div class="main_videos">
          <div class="videos order_2">
            <div class="row g-0">
              <div class="video">
                <img src="/images/video5.jpeg" alt="">
              </div>
              <div class="video_des">
                <p class="video_des_top">موسیقی در دولت دوازدهم-۳ «احوال »
                </p>
                <h6 class="vide_title">دولتی که «موسیقی» را بی صدا کرد/ماشین صدور مجوز و دیگر هیچ!</h6>
              </div>
            </div>
            <hr>
            <div class="row g-0">
              ...
              <div class="video_des">
                <p class="video_des_top">مجدالدین معلمی با مهر مطرح کرد</p>
                <h6 class="vide_title">کمبود های آثار گنجینه حوزه هنری رفع می شود/تولید آثار بامخاطب </h6>
              </div>
            </div>
            <hr>
            <div class="row g-0">
              ...
              <div class="video_des">
                <p class="video_des_top">به عنوان یک بلاک باستر بزرگ</p>
                <h6 class="vide_title"> «سریع و خشمگین ۹» به جشنواره کن می رود</h6>
              </div>
            </div>
            <hr>
            <div class="row g-0">
              ...
              <div class="video_des">
                <p class="video_des_top">در یک گفتگوی مجازی مطرح شد؛</p>
                <h6 class="vide_title">فیلمسازی اپوزیستونی که از دولت وام می گیرند! وضع شترگاوپلنگ سینما</h6>
              </div>
            </div>
          </div>
          <div class="wrapper_space_video"></div>
        </div>
      </div>
      <div class="col-12 col-lg-cus-22 order-cus-1">
        <div class="main_video ">
          <div class="b_video order_1">
  ...
  <!--====== ayeha ======-->
  <section class="container container_custom p-0 main-body">
    <div class="p-absolute wrapper_ayeha"></div>
    <div class="row g-0">
      <div class="col-md-12 col-sm-12 p-0">
        <div class="mrb_20">
          <div class="wrapper_space_ayeha p-0"></div>
          <div class="wrapper_cover_ayeha">
            <header class="header_ayeha">
              <div class="ayeha_logo"></div>
              <div id="ayeha_tabs" class="ayeha_tabs">
                <li class="ayhea_tab">آسمانه</li>
                <li class="ayhea_tab">نشانک</li>
                <li class="ayhea_tab">اخبار موسسات</li>
                <li class="ayhea_tab">سلامت</li>
                <li class="ayhea_tab">جیب</li>
                <li class="ayhea_tab">مجازیست</li>
              </div>
            </header>
            <div class="ayeha_contents ">
              <div class="ayeha_item_contents">
                <div class="row">
                  <div class="col-12 col-lg-6">
                    <section class="ayeha_content ">
                      <div class="ayeha_img">
                        <img src="/images/ayeha1.jpg" alt="">
                      </div>
                      <div class="ayeha_text_main">
                        <a href="">
                          گزارش روزنامه ایتالیایی از علاقه تیم «مورینیو» به جذب «آزمون»
                        </a>
                      </div>
                    </section>
                  </div>
                  <div class="col-12 col-lg-6">
                    <div class="row g-0">
                      <div class="col-12 col-sm-6">
                        <div class="ayeha_content_item_one">
                          <div class="ayeha_content_img">
                            <img src="/images/ayeha3.jpg" alt="">
                          </div>
                          <div class="ayeha_text">
                            <a href="">
                              نگرانی از زوال اخلاق و لطمه به حیثیت نظام در مناظره ها
                            </a>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="ayeha_content_item_two">
                          <div class="ayeha_content_img">
                            <img src="/images/ayeha2.jpg" alt="">
                          </div>
                          <div class="ayeha_text">
                            <a href="">
                              سازوکار شبکه های اختصاصی نامزدهای انتخابا
                            </a>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="ayeha_content_item_three">
                          <div class="ayeha_content_img">
                            <img src="/images/ayeha4.jpg" alt="">
                          </div>
                          <div class="ayeha_text">
                            <a href="">
                              صنعت برق پشت فعالیت های صنعتی - تولیدی را خالی نکند
                            </a>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-sm-6">
                        <div class="ayeha_content_item_four">
                          <div class="ayeha_content_img">
                            <img src="/images/ayeha5.jpg" alt="">
                          </div>
                          <div class="ayeha_text">
                            <a href="">
                              ناتوانی زنگنه در تحقق برنامه تولید نقت
                            </a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="more_info" style="float: left;">
                      <a href="#">
                        <span class="more_info_txt">ویدیو های بیشتر </span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" viewBox="0 0 18 13">
                          <path id="Rectangle_17_copy_4" data-name="Rectangle 17 copy 4" class="cls-1"
          ...
          <div class="wrapper_space_ayeha p-0">
          </div>
        </div>
      </div>
    </div>
  ...
  <!--====== Ostan ======-->
  <section class="container container_custom p-0 main-body">
    <div class="p-absolute wrapper_Ostan"></div>
    <div class="row g-0">
      <div class="col-md-12 col-sm-12 p-0">
        <div class="mrb_20">
          <div class="Ostan">
            <div class="row g-0">
              <div class="col-lg-5">
                ...
                <div class="map-sec d-none d-lg-block">
                  <div id="IranMap">
                    <div class="map">
                      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="20 0 970 960"
                        ...
                        <g class="province">
                          <path class="alborz" title="البرز" id="path_8"
                          ...
                          <path class="ardabil" title="اردبیل" id="path_6"
                            ...
                            style=""></path>
                          <path class="azerbaijan-east" title="آذربایجان شرقی" id="path_4"
                            ...
                            style=""></path>
                          <path class="azerbaijan-west" title="آذربایجان غربی" id="path_5"
                            ...
                            style=""></path>
                          <path class="bushehr" title="بوشهر" id="path_10"
                            ...
                            style=""></path>
                          <path class="chahar-mahaal-bakhtiari" title="چهار محال و بختیاری" id="path_12"
                          ...
                          <path class="fars" title="فارس" id="path_20"
                          ...
                          <path class="gilan" title="گیلان" id="path_28"
                          ...
                          <path class="golestan" title="گلستان" id="path_27"
                          ...
                          <path class="hamadan" title="همدان" id="path_33"
                            ...
                            style=""></path>
                          <path class="hormozgan" title="هرمزگان" id="path_32"
                          ...
                          <path class="ilam" title="ایلام" id="path_9"
                          ...
                          <path class="isfahan" title="اصفهان" id="path_7"
                          ...
                          <path class="kerman" title="کرمان" id="path_24"
                          ...
                          <path class="kermanshah" title="کرمانشاه" id="path_25"
                            ...
                            style=""></path>
                          <path class="khorasan-north" title="خراسان شمالی" id="path_15"
                          ...
                          <path class="khorasan-razavi" title="خراسان رضوی" id="path_14"
                            ...
                            style=""></path>
                          <path class="khorasan-south" title="خراسان جنوبی" id="path_13"
                          ...
                          <path class="khuzestan" title="خوزستان" id="path_16"
                          ...
                          <path class="kohgiluyeh-boyer-ahmad" title="کهگیلویه و بویراحمد" id="path_26"
                          ...
                          <path class="kurdistan" title="کردستان" id="path_23"
                          ...
                          <path class="lorestan" title="" id="path_29"
                          ...
                          <path class="markazi" title="مرکزی" id="path_31"
                          ...
                          <path class="mazandaran" title="مازندران" id="path_30"
                          ...
                          <path class="qazvin" title="قزوین" id="path_21"
                            ...
                            style="fill: rgb(0, 182, 203);"></path>
                          <path class="qom" title="قم" id="path_22"
                          ...
                          <path class="semnan" title="سمنان" id="path_18"
                          ...
                          <path class="sistan-baluchestan" title="سیستان و بلوچستان" id="path_19"
                          ...
                          <path class="tehran" title="تهران" id="path_11"
                            ...
                            style=""></path>
                          <path class="yazd" title="یزد" id="path_34"
                          ...
                          <path class="zanjan" title="زنجان" id="path_17"
                        ...
                        <g class="sea">
                          ...
                          <path class="persian-gulf" title="" id="40"
                        ...
                        <g class="text"> <a href="#" id="text_4"> <text transform="" y="92" x="196" style="">آذربایجان
                              شرقی</text> </a> <a href="#" id="text_5"> <text transform="rotate(61 59,49)" y="92"
                              x="196" style="">اذربایجان غربی</text> </a> <a href="#" id="text_6"> <text transform=""
                              y="132" x="239" style="">اردبیل</text> </a> <a href="#" id="text_7"> <text transform=""
                              y="391" x="449" style="">اصفهان</text> </a> <a href="#" id="text_8"> <text transform=""
                              y="249" x="350" style="">البرز</text> </a> <a href="#" id="text_9"> <text transform=""
                              y="411" x="144" style="">ایلام</text> </a> <a href="#" id="text_10"> <text transform=""
                              y="674" x="387" style="">بوشهر</text> </a> <a href="#" id="text_11"> <text transform=""
                              y="275" x="387" style="">تهران</text> </a> <a href="#" id="text_12"> <text transform=""
                              y="477" x="406" style="">چهار محال و بختیاری</text> </a> <a href="#" id="text_13"> <text
                              transform="" y="444" x="820" style="">خراسان جنوبی</text> </a> <a href="#" id="text_14">
                            <text transform="" y="268" x="790" style="">خراسان رضوی</text> </a> <a href="#"
                            id="text_15"> <text transform="" y="165" x="700" style="">خراسان شمالی</text> </a> <a
                            href="#" id="text_16"> <text transform="" y="510" x="270" style="">خوزستان</text> </a> <a
                            href="#" id="text_17"> <text transform="" y="210" x="240" style="">زنجان</text> </a> <a
                            href="#" id="text_18"> <text transform="" y="277" x="567" style="">سمنان</text> </a> <a
                            href="#" id="text_19"> <text transform="" y="735" x="933" style="">سیستان و بلوچستان</text>
                          </a> <a href="#" id="text_20"> <text transform="" y="623" x="449" style="">فارس</text> </a> <a
                            href="#" id="text_21"> <text transform="" y="230" x="310"
                              style="fill: rgb(255, 255, 255); stroke: rgb(255, 255, 255); font: 18px iranSansBold;">قزوین</text>
                          </a> <a href="#" id="text_22"> <text transform="" y="326" x="340" style="">قم</text> </a> <a
                            href="#" id="text_23"> <text transform="" y="255" x="193" style="">کردستان</text> </a> <a
                            href="#" id="text_24"> <text transform="" y="600" x="642" style="">کرمان</text> </a> <a
                            href="#" id="text_25"> <text transform="" y="330" x="161" style="">کرمانشاه</text> </a> <a
                            href="#" id="text_26"> <text transform="" y="550" x="406" style="">کهگیلویه و
                              بویراحمد</text> </a> <a href="#" id="text_27"> <text transform="" y="182" x="567"
                              style="">گلستان</text> </a> <a href="#" id="text_28"> <text transform="" y="174" x="296"
                              style="">گیلان</text> </a> <a href="#" id="text_29"> <text transform="" y="395" x="261"
                              style="">لرستان</text> </a> <a href="#" id="text_30"> <text transform="" y="230" x="439"
                              style="">مازندران</text> </a> <a href="#" id="text_31"> <text transform="" y="337" x="293"
                              style="">مرکزی</text> </a> <a href="#" id="text_32"> <text transform="" y="735" x="642"
                              style="">هرمزگان</text> </a> <a href="#" id="text_33"> <text transform="" y="293" x="261"
                              style="">همدان</text> </a> <a href="#" id="text_34"> <text transform="" y="450" x="600"
                              style="">یزد</text> </a> </g>
                      </svg>
                    </div>
                  </div>
              ...
              <div class="col-lg-7 ">
                <div class="left_map">
                  <div class="header_ostan">
                    <div class="">

                      <div class="dropdown_map">
                        <div id="selectedOption" class="selected-option"><a href="#path_7"
                            class="selectedOptionName">اصفهان</a>
                    ...
                    <div class="service_ostan">
                      ورود به صفحه استان
                    </div>
                  </div>
                  <div class="row">
                    <div id="apiOstan" class="ostan_item_contents">
                      ...
                      <!-- <article class="ostan_item_content">
                                                <div class="row g-0">
                                                    ...
                                                    <article class="ostan_text">
                                                        <div class="ins_text">
                                                            <p class="muted" style="margin: 0px;">  
                                                                گزارشی از یک جشن شیرین
                                                            </p>
                                                            <h6 class="Titter ostan_titter">          
                                                                جزئیات اتفاقات رختکن تیم ملی
                                                            </h6>
                                                            <p class="ostan_paragraph">
                                                                سند صیانت از کودکان و نوجوانان در فضای مجازی توسط معاونت محتوایی مرکز
                                                                ملی فضایی مجازی تدوین و در انتظار مطرح شدن و تصویب در شورای عالی 
                                                                فضاری مجازی قرار گرفت.
                                                            </p>
                                                        </div>
                                                    </article>
                                                    <hr>
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <article class="ostan_text">
                                                        <div class="ins_text">
                                                            ...
                                                            <h6 class="Titter ostan_titter">          
                                                                مسابقه «انتخابات از دیدگاه امامین انقلاب» بزرگراه می شود
                                                            </h6>
                                                            <p class="ostan_paragraph">
                                                                سند صیانت از کودکان و نوجوانان در فضای مجازی توسط معاونت محتوایی مرکز
                                                                ملی فضایی مجازی تدوین و در انتظار مطرح شدن و تصویب در شورای عالی 
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <article class="ostan_text">
                                                        <div class="ins_text">
                                                            ...
                                                            <h6 class="Titter ostan_titter">          
                                                                مشارکت در انتخابات مصداق تواصی به حق است
                                                            </h6>
                                                            <p class="ostan_paragraph">
                                                               سند صیانت از کودکان و نوجوانان در فضای 
                                                               مجازی توسط معاونت محتوایی مرکز ملی 
                                                               گرفت.
                                                            </p>
                                                        </div>
                                                    </article>
      ...
      <div class="wrapper_space_Ostan p-0">
      </div>
  </section>
  <!--End of the Ostan-->
  ...
  <!--====== Images ======-->
  <section class="container container_custom p-0 main-body">
    <div class="p-absolute wrapper_Image"></div>
    <div class="wrapper_space_Images p-0">
      <div class="row g-0">
        <header class="header_sec " style="padding-bottom: 19px;">
          <div class="header_sec_image">
            <div class="header_image">
              <span class="header_image_icon"></span>
              <span class="header_image_title">
                <a href="" class="header_image_a">گزارش تصویری</a>
              </span>
            </div>
            <div class="more_info">
              <a href="#">
                <span class="more_info_txt">تصاویر بیشتر </span>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" viewBox="0 0 18 13">
                  <path id="Rectangle_17_copy_4" data-name="Rectangle 17 copy 4" class="cls-1"
                    d="M17.858,6.779H2.009L6.58,11.35l-0.707.707L0.095,6.279,0.8,5.572,5.58,0.794,6.287,1.5,2.008,5.78h15.85v1Z" />
                </svg>
        ...
        <!-- image right -->
        <div class="d-none d-lg-block col-lg-cus-7">
          <section class="Image_right">
            <div class="pic">
              <img src="/images/img0.jpg" id="0" alt="">
            </div>
            <div class="pic">
              <img src="/images/img1.jpg" id="1" alt="">
            </div>
            <div class="pic">
              <img src="/images/img2.jpg" id="2" alt="">
            </div>
          </section>
        </div>
        <!-- End of the image right -->
        <div class="col-12 col-lg-cus-22 pdx_10">
          <section class="Image_center ">
            <div class="swiper swiperImages mySwiperImg  swiper-initialized swiper-horizontal swiper-backface-hidden">
        ...
        <div class="d-none d-lg-block col-lg-cus-7">
          <section class="Image_left">
            <div class="pic">
              <img src="/images/Img3.jpg" id="3" alt="">
            </div>
            <div class="pic">
              <img src="/images/img4.jpg" id="4" alt="">
            </div>
            <div class="pic">
              <img src="/images/img5.jpg" id="5" alt="">
            </div>
          </section>
        </div>
        <!-- End of the image left -->
        <!-- </div> -->
      </div>
  </section>
  <!-- End of the Images -->
  ...
  <!--====== media ======-->
  <section class="container container_custom media  p-0">
    <div class="row g-0">
      ...
      <div class="d-none d-lg-inline col-lg-8">
        <div class="media-center">
          <div class="navigation_center">
            <ul class="navigation_center_ul">
              <li class=""><a href="#">آرشیو</a></li>
              <li class=""><a href="#">جستجو</a></li>
              <li><a href="#">پیوند ها</a></li>
              <li class=""><a href="#">نظرسنجی</a></li>
              <li class=""><a href="#"> آب و هوا</a></li>

              <li><a href="#">خبرنامه</a></li>
              <li class=""><a href="#"> آب و هوا</a></li>
              <li class=""><a href="#">اوقات شرعی </a></li>

              <li class=""><a href="#">سوالات متداول</a></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <ul>
            <li><a href="">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                  y="0px" width="23px" height="23px" viewBox="0 0 500 500" enable-background="new 0 0 500 500"
                  xml:space="preserve">
                  <g>
                    <g>
                      <path fill="#79c5cd"
                        d="M214.665,31.71l-39.841-9.742c-40.26-9.847-80.88,14.812-90.728,55.073l-9.967,40.761                                                 C108.097,72.192,158.646,41.259,214.665,31.71z">
                      </path>
                      <path fill="#79c5cd"
                        d="M471.285,221.282l11.438-46.759c9.845-40.262-14.813-80.882-55.074-90.728L385.387,73.46                                                 C432.442,109.122,463.595,162.54,471.285,221.282z">
                      </path>
                      <path fill="#79c5cd"
                        d="M282.446,469.235l48.07,11.755c40.262,9.846,80.883-14.812,90.73-55.074l12.022-49.179                                                 C398.099,427.071,343.208,460.712,282.446,469.235z">
                      </path>
                      <path fill="#79c5cd"
                        d="M33.179,285.256l-10.559,43.179c-9.847,40.262,14.811,80.883,55.071,90.728l45.648,11.164                                                 C75.18,396.014,42.611,343.522,33.179,285.256z">
                      </path>
                    </g>
                    <path fill="#79c5cd"
                      d="M252.672,46.092c-111.809,0-202.447,90.639-202.447,202.447c0,111.806,90.638,202.446,202.447,202.446                                             c111.81,0,202.445-90.64,202.445-202.446C455.117,136.73,364.481,46.092,252.672,46.092z M193.837,100.125                                             c32.494,0,58.835,26.341,58.835,58.834s-26.341,58.834-58.835,58.834s-58.834-26.341-58.834-58.834                                             S161.343,100.125,193.837,100.125z M165.06,370.618c-32.494,0-58.834-26.341-58.834-58.833c0-32.493,26.341-58.835,58.834-58.835                                             c32.494,0,58.835,26.342,58.835,58.835C223.895,344.277,197.554,370.618,165.06,370.618z M252.358,276.974                                             c-14.081,0-25.495-11.413-25.495-25.494s11.414-25.495,25.495-25.495c14.08,0,25.494,11.414,25.494,25.495                                             S266.438,276.974,252.358,276.974z M312.147,398.564c-32.494,0-58.834-26.34-58.834-58.834c0-32.491,26.34-58.834,58.834-58.834                                             s58.835,26.343,58.835,58.834C370.982,372.225,344.642,398.564,312.147,398.564z M341.407,244.349                                             c-32.494,0-58.835-26.341-58.835-58.834c0-32.494,26.341-58.834,58.835-58.834s58.834,26.341,58.834,58.834                                             C400.241,218.008,373.901,244.349,341.407,244.349z">
                    </path>
                  </g>
                </svg>
              </a></li>
            <li><a href="">
                <svg id="Layer_1" fill="#79c5cd" width="25px" height="25px" style="enable-background:new 0 0 30 30;"
...
>
  <!-- <?php echo '<script'; ?>
 src="/js/swiper-bundle.min.js"><?php echo '</script'; ?>
> -->
  <?php echo '<script'; ?>
 src="bootstrap-5.1.3-dist/js/bootstrap.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="bootstrap-5.1.3-dist/js/bootstrap.bundle.min.js"><?php echo '</script'; ?>
>
  <!-- JQuery -->
  <?php echo '<script'; ?>
